      ...
      desc = [=[
        ...
        |ins-completion|.  The supported values are:
           ...
           preinsert
        	    ...
        	    When 'autocomplete' is enabled, this does not work if
        	    'ignorecase' is set without 'infercase'.  With "fuzzy", a
        	    candidate that does not continue the leader has nothing to
        	    show and is not previewed.
