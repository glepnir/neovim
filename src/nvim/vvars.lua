    ...
    desc = [=[
      ...
      event, e.g. |DirChanged| or |TextYankPost|.
        ...
        col              Column count of popup menu on |CompleteChanged|,
                         relative to screen.
        complete_leader  Text the matches are filtered by on
                         |CompleteChanged|, i.e. what was typed since
                         the completion started.  Not the same as
                         reading the line: a match may be shown in the
                         buffer in its place.
