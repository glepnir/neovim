...
function M._lsp_to_complete_items(result, prefix, client_id)
  ...
  local user_sort = vim.tbl_get(buf_handles, bufnr, 'sort')
...
--- @field sort? fun(a: table, b: table): boolean Comparator for sorting merged completion items from all servers.
...
local function enable_completions(client_id, bufnr, opts)
  ...
  if not buf_handle then
    buf_handle = { clients = {}, triggers = {}, convert = opts.convert, sort = opts.sort }
