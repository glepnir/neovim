...
describe('previewpopup option', function()
  ...
  local function with_ext_multigrid(multigrid)
    ...
    it('invalid argument in previewpopup', function()
      ...
      eq('nvim_exec2(), line 1: Vim(set): previewpopup: height must be a positive integer', err)

      err = pcall_err(n.exec_capture, 'set previewpopup=width:yes')
      eq('nvim_exec2(), line 1: Vim(set): previewpopup: width must be a positive integer', err)
    end)
  end
